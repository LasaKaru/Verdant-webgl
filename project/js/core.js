...
const WORLD = 130;      // half-extent of the playable square
...
const Game = {
  state: 'loading',
  settings: { quality:'med', shadows:true, cycle:true, sens:1.2, volume:0.55, fov:74*Math.PI/180, density:140, weatherMode:'auto' },
...
function setState(s){
  Game.state = s;
  ['loader','menu','settings','mp','howto','pause','over','inv','shop','map','garage','contracts','customize'].forEach(hide);
